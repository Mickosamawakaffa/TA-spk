...
<?php $__env->startSection('title', 'Edit Kontrakan'); ?>
...
<div class="container-fluid px-4">
    ...
    <div class="page-header mb-4">
        <h2 class="mb-2">
            <i class="bi bi-pencil-square me-2"></i>Edit Kontrakan
        </h2>
        <p class="mb-0 fs-6">Update informasi kontrakan <strong><?php echo e($kontrakan->nama); ?></strong></p>
    </div>
        ...
        <div class="col-12">
            <div class="card form-card">
                <div class="card-body p-4">
                    <form action="<?php echo e(route('kontrakan.update', $kontrakan->id)); ?>" method="POST" enctype="multipart/form-data" id="kontrakanForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            value="<?php echo e(old('nama', $kontrakan->nama)); ?>"
                                            required
                                        >
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            required
                                        ><?php echo e(old('alamat', $kontrakan->alamat)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            value="<?php echo e(old('no_whatsapp', $kontrakan->no_whatsapp)); ?>"
                                            maxlength="20"
                                        >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <ul class="mb-0 mt-2 small">
                                            ...
                                            <li class="mb-2">
                                                <strong class="text-primary">📍 Deteksi GPS</strong>
                                                <div class="text-muted" style="font-size: 0.85rem;">
                            ...
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <button type="button" id="detectLocation" class="btn btn-outline-primary w-100">
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            value="<?php echo e(old('latitude', $kontrakan->latitude)); ?>"
                                            step="0.00000001"
                                            min="-90"
                                            max="90"
                                            required
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            value="<?php echo e(old('longitude', $kontrakan->longitude)); ?>"
                                            step="0.00000001"
                                            min="-180"
                                            max="180"
                                            required
...
unset($__errorArgs, $__bag); ?>" 
                                            id="harga" 
                                            placeholder="500000"
                                            value="<?php echo e(old('harga', $kontrakan->harga)); ?>"
                                            min="0"
                                            required
                                        >
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            value="<?php echo e(old('jumlah_kamar', $kontrakan->jumlah_kamar)); ?>"
                                            min="1"
                                            step="1"
                                            required
                                        >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <!-- bathroom_count -->
                                <div class="col-md-6">
                                    <label for="bathroom_count" class="form-label fw-semibold">
                                        Jumlah Kamar Mandi
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-light border-end-0">
                                        ...
                                        <input 
                                            type="number" 
                                            name="bathroom_count" 
                                            class="form-control border-start-0 <?php $__errorArgs = ['bathroom_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            value="<?php echo e(old('bathroom_count', $kontrakan->bathroom_count ?? 1)); ?>"
                                            min="0"
                                            step="1"
                                        >
                                        <span class="input-group-text bg-light">kamar</span>
                                        <?php $__errorArgs = ['bathroom_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <small class="text-muted">Informasi kamar mandi untuk detail kontrakan</small>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            value="<?php echo e(old('jarak', $kontrakan->jarak)); ?>"
                                            min="0"
                                            readonly
                                            required
                                        >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="fasilitas" id="fasilitas" value="<?php echo e(old('fasilitas', $kontrakan->fasilitas)); ?>">
                                    <div class="border rounded p-2 bg-light <?php $__errorArgs = ['fasilitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                        <div class="row g-2">
                                            <?php $__currentLoopData = $facilityOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-6">
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            <?php echo e(in_array(strtolower($facility), $selectedFacilities) ? 'checked' : ''); ?>

                                                        >
                                                        <label class="form-check-label small" for="fasilitas_<?php echo e($loop->index); ?>">
                                                            <?php echo e($facility); ?>
                                            ...
                                            <div class="col-md-4 text-center mb-3 mb-md-0">
                                                ...
                                                <?php else: ?>
                                                    <div class="py-3">
                                                        ...
                                                        <p class="text-muted mb-0 small">Belum ada foto</p>
                                                    </div>
                                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="alert alert-info border-info border-2 mb-4">
                            ...
                            <p class="mb-0 small">
                                Anda sedang mengedit data kontrakan <strong><?php echo e($kontrakan->nama); ?></strong>. 
            ...
            <div class="info-card">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-1 small">
                            <strong>Dibuat:</strong> <?php echo e($kontrakan->created_at->format('d M Y, H:i')); ?> WIB
                        </p>
                        <?php if($kontrakan->updated_at != $kontrakan->created_at): ?>
                        <p class="mb-0 small">
                            <strong>Terakhir diupdate:</strong> <?php echo e($kontrakan->updated_at->format('d M Y, H:i')); ?> WIB
                        </p>
                        <?php endif; ?>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ========== GET EXISTING DATA ==========
    const existingLat = <?php echo e($kontrakan->latitude ?? 'null'); ?>;
    const existingLng = <?php echo e($kontrakan->longitude ?? 'null'); ?>;
    
    // ========== MAP INITIALIZATION ==========
    const initialLat = existingLat || KAMPUS_LAT;
    const initialLng = existingLng || KAMPUS_LNG;
    
    const map = L.map('map').setView([initialLat, initialLng], existingLat ? 15 : 13);
    ...
    // ========== FUNCTION: REVERSE GEOCODING (KOORDINAT → ALAMAT) ==========
    ...
    // ========== INITIALIZE MARKER WITH EXISTING DATA ==========
    if (existingLat && existingLng) {
        addMarker(existingLat, existingLng, false); // false = don't reverse geocode on load
    }
    ...
    function calculateDistance(lat, lng) {
        ...
        console.log('📏 Jarak ke kampus:', distance, 'meter');
    }
    
    // ========== INPUT MANUAL KOORDINAT → UPDATE PETA ==========
    ...
    // ========== CLICK ON MAP → AUTO UPDATE ALAMAT ==========
...
<style>
    ...
    /* Highlight saat input manual aktif */
    ...
    *:focus-visible {
    ...
    /* Checkbox styling for "Hapus foto" */
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TA\spk_kontrakan\resources\views/kontrakan/edit.blade.php ENDPATH**/ ?>