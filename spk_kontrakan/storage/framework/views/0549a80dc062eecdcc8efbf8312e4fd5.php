...
<?php $__env->startSection('title', 'Detail Kontrakan'); ?>
...
<div class="container-fluid px-4">
    ...
    <div class="detail-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h2 class="mb-2">
                    <i class="bi bi-houses me-2"></i><?php echo e($kontrakan->nama); ?>

                    <span class="badge <?php echo e($kontrakan->status_badge_class); ?> fs-6 ms-2"><?php echo e($kontrakan->status_label); ?></span>
                </h2>
                <p class="mb-0 fs-6">Informasi lengkap dan detil kontrakan</p>
            </div>
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('admin.bookings.kontrakan-history', $kontrakan->id)); ?>" class="btn btn-outline-light me-2">
                    <i class="bi bi-calendar-check me-2"></i>Riwayat Booking
                </a>
                <a href="<?php echo e(route('kontrakan.edit', $kontrakan->id)); ?>" class="btn btn-edit me-2">
                    <i class="bi bi-pencil me-2"></i>Edit
                </a>
                <a href="<?php echo e(route('kontrakan.index')); ?>" class="btn btn-outline-light">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8">
                        <div class="d-flex gap-2 flex-wrap justify-content-md-end">
                            <form action="<?php echo e(route('kontrakan.update-status', $kontrakan->id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="status" value="available">
                                <button type="submit" class="btn btn-<?php echo e($kontrakan->status === 'available' ? 'success' : 'outline-success'); ?> btn-sm" <?php echo e($kontrakan->status === 'available' ? 'disabled' : ''); ?>>
                            ...
                            <form action="<?php echo e(route('kontrakan.update-status', $kontrakan->id)); ?>" method="POST" class="d-inline">
                                ...
                                <button type="submit" class="btn btn-<?php echo e($kontrakan->status === 'booked' ? 'warning' : 'outline-warning'); ?> btn-sm" <?php echo e($kontrakan->status === 'booked' ? 'disabled' : ''); ?>>
                            ...
                            <form action="<?php echo e(route('kontrakan.update-status', $kontrakan->id)); ?>" method="POST" class="d-inline">
                                ...
                                <button type="submit" class="btn btn-<?php echo e($kontrakan->status === 'occupied' ? 'danger' : 'outline-danger'); ?> btn-sm" <?php echo e($kontrakan->status === 'occupied' ? 'disabled' : ''); ?>>
                            ...
                            <form action="<?php echo e(route('kontrakan.update-status', $kontrakan->id)); ?>" method="POST" class="d-inline">
                                ...
                                <button type="submit" class="btn btn-<?php echo e($kontrakan->status === 'maintenance' ? 'secondary' : 'outline-secondary'); ?> btn-sm" <?php echo e($kontrakan->status === 'maintenance' ? 'disabled' : ''); ?>>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-9">
            ...
            <div class="detail-card">
                ...
                <div class="card-body p-0">
                    <div class="position-relative" style="height: 400px; overflow: hidden;">
                        <img 
                            src="<?php echo e(asset('uploads/kontrakan/' . $kontrakan->foto)); ?>" 
                            alt="<?php echo e($kontrakan->nama); ?>" 
                            class="w-100 h-100"
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    <?php if($kontrakan->galeri->count() > 0): ?>
                        <div class="row g-3">
                            <?php $__currentLoopData = $kontrakan->galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="position-relative galeri-item">
                                    <img 
                                        src="<?php echo e(asset('uploads/galeri/kontrakan/' . $foto->foto)); ?>" 
                                        alt="Foto <?php echo e($kontrakan->nama); ?>"
                                    ...
                                    <div class="position-absolute top-0 end-0 m-2">
                                        <div class="btn-group-vertical" role="group">
                                            <?php if(!$foto->is_primary): ?>
                                            <form action="<?php echo e(route('galeri.set-primary', $foto->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <form action="<?php echo e(route('galeri.delete', $foto->id)); ?>" method="POST" 
            ...
            <div class="modal fade" id="uploadGaleriModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('galeri.upload', $kontrakan->id)); ?>" 
            ...
            <div class="detail-card">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center gap-3 mt-2">
                                <div class="d-flex align-items-center">
                                    <span class="fs-4 fw-bold me-2"><?php echo e($kontrakan->average_rating); ?></span>
                                    <div>
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <?php if($i <= $kontrakan->average_rating): ?>
                                ...
                                <span class="text-muted">(<?php echo e($kontrakan->total_reviews); ?> review)</span>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <?php if($kontrakan->reviews->count() > 0): ?>
                        <div class="review-list">
                            <?php $__currentLoopData = $kontrakan->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="review-item border-bottom pb-3 mb-3">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            <button type="button" class="btn btn-outline-secondary" 
                                                    onclick="editReview(<?php echo e($review->id); ?>, <?php echo e($review->rating); ?>, '<?php echo e(addslashes($review->review ?? '')); ?>')">
                                ...
                                <p class="mb-0 ms-5"><?php echo e($review->review); ?></p>
                                <?php endif; ?>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
            ...
            <!-- MAPS SECTION -->
            <?php if($kontrakan->latitude && $kontrakan->longitude): ?>
            <div class="detail-card">
                <div class="detail-card-header d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
                    ...
                    <a href="https://www.google.com/maps?q=<?php echo e($kontrakan->latitude); ?>,<?php echo e($kontrakan->longitude); ?>" 
                       target="_blank" 
                        ...
                        <div class="col-md-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-0 fw-semibold"><?php echo e($kontrakan->nama); ?></h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-0"><?php echo e($kontrakan->alamat); ?></p>
                                </div>
                            </div>
                        </div>

                        <!-- WhatsApp Section -->
                        <?php if($kontrakan->no_whatsapp): ?>
                        <div class="col-md-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-2 fw-semibold text-success"><?php echo e($kontrakan->no_whatsapp); ?></h5>
                                    <div class="d-flex flex-wrap gap-2">
                                        <a 
                                            href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $kontrakan->no_whatsapp)); ?>" 
                                            target="_blank"
                                        ...
                                        <a 
                                            href="tel:<?php echo e(preg_replace('/[^0-9]/', '', $kontrakan->no_whatsapp)); ?>" 
                                        ...
                                        <button 
                                            ...
                                            onclick="copyWhatsApp('<?php echo e($kontrakan->no_whatsapp); ?>')"
                                        >
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-0 fw-semibold text-success">
                                        Rp <?php echo e(number_format($kontrakan->harga, 0, ',', '.')); ?>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-0 fw-semibold" style="color: #667eea;">
                                        <?php echo e($kontrakan->jumlah_kamar ?? 1); ?> kamar
                                    </h5>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-0 fw-semibold" style="color: #17a2b8;">
                                        <?php echo e($kontrakan->bathroom_count ?? 1); ?> kamar
                                    </h5>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-0 fw-semibold text-info">
                                        <?php echo e(number_format($kontrakan->jarak, 0, ',', '.')); ?> meter
                                    </h5>
                                    <small class="text-muted">≈ <?php echo e(round($kontrakan->jarak / 1000, 2)); ?> km</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <?php if($kontrakan->fasilitas): ?>
                                        <div class="d-flex flex-wrap gap-2 mt-2">
                                            <?php $__currentLoopData = explode(',', $kontrakan->fasilitas); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-lg-3">
            ...
            <div class="detail-card" style="background: linear-gradient(135deg, #25D366 0%, #128C7E 100%); border: none !important; color: white;">
                <div class="card-body p-4">
                    ...
                    <div class="bg-white bg-opacity-20 rounded p-3 mb-3 text-center">
                        ...
                        <h4 class="mb-0 fw-bold"><?php echo e($kontrakan->no_whatsapp); ?></h4>
                    </div>
                    <a 
                        href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $kontrakan->no_whatsapp)); ?>?text=Halo,%20saya%20tertarik%20dengan%20kontrakan%20*<?php echo e(urlencode($kontrakan->nama)); ?>*%20yang%20terletak%20di%20<?php echo e(urlencode($kontrakan->alamat)); ?>.%20Apakah%20masih%20tersedia?" 
                        target="_blank"
            ...
            <div class="detail-card">
                <div class="card-body p-4 text-center">
                    ...
                    <form action="<?php echo e(route('favorites.kontrakan.toggle', $kontrakan->id)); ?>" 
      method="POST" id="favoriteForm">
    <?php echo csrf_field(); ?>
    <button type="submit" class="btn <?php echo e($isFavorited ? 'btn-danger' : 'btn-outline-danger'); ?> w-100" 
            id="favoriteBtn">
        <i class="bi bi-heart<?php echo e($isFavorited ? '-fill' : ''); ?> me-2" id="favoriteIcon"></i>
        <span id="favoriteBtnText"><?php echo e($isFavorited ? 'Hapus dari Favorit' : 'Tambah ke Favorit'); ?></span>
    </button>
</form>

<small class="text-muted d-block mt-2">
                    <i class="bi bi-people me-1"></i>
                    <span id="totalFavorites"><?php echo e($kontrakan->total_favorites); ?></span> orang menyukai ini
                </small>
            </div>
        </div>
        ...
        <div class="detail-card">
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
                    ...
                    <strong>Rp <?php echo e(number_format($kontrakan->harga / 12, 0, ',', '.')); ?></strong>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
                    <span class="text-muted">Harga/m²</span>
                    <strong>Rp <?php echo e(number_format($kontrakan->harga / $kontrakan->jumlah_kamar, 0, ',', '.')); ?></strong>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
        ...
        <div class="card border-0 bg-light mb-4">
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <strong><?php echo e($kontrakan->created_at->format('d M Y, H:i')); ?> WIB</strong>
                </div>
                <?php if($kontrakan->updated_at != $kontrakan->created_at): ?>
                <div>
                    <small class="text-muted d-block">Terakhir Diupdate</small>
                    <strong><?php echo e($kontrakan->updated_at->format('d M Y, H:i')); ?> WIB</strong>
                    <small class="text-muted d-block mt-1">
                        (<?php echo e($kontrakan->updated_at->diffForHumans()); ?>)
                    </small>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('kontrakan.edit', $kontrakan->id)); ?>" class="btn btn-warning">
                        <i class="bi bi-pencil me-2"></i>Edit Data
                    </a>
                    
                    <?php if(auth()->user()->role == 'super_admin'): ?>
                    <form action="<?php echo e(route('kontrakan.destroy', $kontrakan->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus kontrakan <?php echo e($kontrakan->nama); ?>?')">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const lat = <?php echo e($kontrakan->latitude); ?>;
    const lng = <?php echo e($kontrakan->longitude); ?>;
    ...
    const popupContent = `
        <div class="p-2" style="min-width: 200px;">
            <h6 class="fw-bold mb-2"><?php echo e($kontrakan->nama); ?></h6>
            <p class="small text-muted mb-2">
                <i class="bi bi-geo-alt me-1"></i><?php echo e(Str::limit($kontrakan->alamat, 50)); ?>
...
function openImageModal(src) {
    ...
    modalImg.src = src;
    caption.innerHTML = '<?php echo e($kontrakan->nama); ?>';
...
if(reviewModal) {
    ...
    reviewForm.action = "<?php echo e(route('reviews.kontrakan.store', $kontrakan->id)); ?>";
}
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TA\spk_kontrakan\resources\views/kontrakan/show.blade.php ENDPATH**/ ?>