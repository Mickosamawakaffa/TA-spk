                ...
                <div class="card-body text-white p-3 p-md-4" style="position: relative; z-index: 2;">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-2 mb-md-3 fw-bold display-6 counter" data-target="<?php echo e($jumlahKontrakan); ?>">0</h2>
                            <p class="mb-0 opacity-85 small d-none d-md-block">
                                <i class="bi bi-currency-dollar me-1"></i>
                                Rp <?php echo e(number_format($avgHargaKontrakan, 0, ',', '.')); ?>
                ...
                <div class="card-body text-white p-3 p-md-4" style="position: relative; z-index: 2;">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-2 mb-md-3 fw-bold display-6 counter" data-target="<?php echo e($jumlahLaundry); ?>">0</h2>
                            <p class="mb-0 opacity-85 small d-none d-md-block">
                                <i class="bi bi-clock-history me-1"></i>
                                <?php echo e($avgKecepatan ?? 'N/A'); ?> jam rata-rata
                            </p>
                        </div>
                        <div class="rounded-circle p-2 p-md-3 d-flex align-items-center justify-content-center d-none d-sm-flex" style="min-width: 50px; min-height: 50px; background: rgba(255,255,255,0.25);">
                ...
                <div class="card-body text-white p-3 p-md-4" style="position: relative; z-index: 2;">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-2 mb-md-3 fw-bold display-6 counter" data-target="<?php echo e($jumlahKriteria); ?>">0</h2>
                            <p class="mb-0 opacity-85 small d-none d-md-block">
            ...
            <div class="card chart-card">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(route('laundry.create')); ?>" class="btn btn-admin-outline w-100 py-3">
                                <i class="bi bi-water me-2"></i> Tambah Laundry
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="<?php echo e(route('kriteria.create')); ?>" class="btn btn-admin-outline w-100 py-3">
                                <i class="bi bi-list-check me-2"></i> Tambah Kriteria
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="<?php echo e(route('saw.index')); ?>" class="btn btn-admin-solid w-100 py-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0"><?php echo e($totalAdmins ?? 1); ?></h3>
                        </div>
                        <div style="font-size: 2.5rem; opacity: 0.3;">👤</div>
                    </div>
                </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            <div class="card chart-card">
                ...
                <div class="card-body">
                    <?php if($recentKontrakan && $recentKontrakan->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $recentKontrakan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <small class="text-muted">
                                            <i class="bi bi-geo-alt-fill me-1"></i><?php echo e($k->lokasi ?? $k->alamat); ?>
                    ...
                    <?php endif; ?>
                    <div class="mt-3">
                        <a href="<?php echo e(route('kontrakan.index')); ?>" class="btn btn-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
        ...
        <div class="col-lg-6">
            <div class="card chart-card">
                ...
                <div class="card-body">
                    <?php if($recentLaundry && $recentLaundry->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            <thead class="table-light">
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-semibold"><?php echo e($l->nama); ?></div>
                                        <?php if($l->layanan && $l->layanan->count() > 0): ?>
                                            <small class="text-muted">
                                                <?php echo e($l->layanan->count()); ?> layanan
                                            </small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <small class="text-muted">
                                            <i class="bi bi-geo-alt-fill me-1"></i><?php echo e($l->alamat ?? '-'); ?>
                                    ...
                                    <td class="text-end">
                                        <?php if($l->layanan && $l->layanan->count() > 0): ?>
                                            ...
                                            <span class="badge bg-success-subtle text-success px-3 py-2">
                                                Rp <?php echo e(number_format($minHarga, 0, ',', '.')); ?>
                    ...
                    <?php endif; ?>
                    <div class="mt-3">
                        <a href="<?php echo e(route('laundry.index')); ?>" class="btn btn-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                            <i class="bi bi-arrow-right-circle me-1"></i> Lihat Semua Data
                        </a>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 1.25rem;">
                    ...
                    <div class="col-4">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h5 class="mt-1 mb-0 fw-bold" style="color: #667eea; font-size: 1.25rem;"><?php echo e($jumlahKontrakan); ?></h5>
                    ...
                    <div class="col-4">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h6 class="mt-1 mb-0 fw-bold" style="color: #667eea; font-size: 0.85rem;">Rp <?php echo e(number_format($avgHargaKontrakan / 1000, 0)); ?>k</h6>
                    ...
                    <div class="col-4">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h5 class="mt-1 mb-0 fw-bold" style="color: #667eea; font-size: 1.25rem;"><?php echo e($jarakKontrakan['dekat'] + $jarakKontrakan['sedang'] + $jarakKontrakan['jauh']); ?></h5>
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span class="badge" style="font-size: 0.7rem; background-color: #667eea;"><?php echo e($recentKontrakan->count() ?? 0); ?> data</span>
                </div>
                <?php if($recentKontrakan && $recentKontrakan->count() > 0): ?>
                        ...
                        <div class="list-group-item px-0 py-2">
                            <div class="d-flex w-100 justify-content-between align-items-start">
                                <div class="flex-grow-1 me-2">
                                    <h6 class="mb-1 fw-semibold" style="font-size: 0.875rem;"><?php echo e($k->nama); ?></h6>
                                    <p class="mb-0 text-muted" style="font-size: 0.75rem;">
                                        <i class="bi bi-geo-alt me-1"></i><?php echo e(Str::limit($k->lokasi ?? $k->alamat, 30)); ?>

                                    </p>
                                </div>
                                <span class="badge" style="font-size: 0.75rem; white-space: nowrap; background-color: #667eea;">
                                    Rp <?php echo e(number_format($k->harga / 1000, 0)); ?>k
                                </span>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 1.25rem;">
                    ...
                    <div class="col-4">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h5 class="mt-1 mb-0 fw-bold" style="color: #f5576c; font-size: 1.25rem;"><?php echo e($jumlahLaundry); ?></h5>
                    ...
                    <div class="col-4">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h5 class="mt-1 mb-0 fw-bold" style="color: #f5576c; font-size: 1.25rem;"><?php echo e($avgKecepatan ?? 'N/A'); ?></h5>
                    ...
                    <div class="col-4">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h5 class="mt-1 mb-0 fw-bold" style="color: #f5576c; font-size: 1.25rem;"><?php echo e($jarakLaundry['dekat'] + $jarakLaundry['sedang'] + $jarakLaundry['jauh']); ?></h5>
                                <p class="mb-0 text-muted" style="font-size: 0.7rem;">Lokasi Tersedia</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span class="badge" style="background: #f5576c; font-size: 0.7rem;"><?php echo e($recentLaundry->count() ?? 0); ?> data</span>
                </div>
                <?php if($recentLaundry && $recentLaundry->count() > 0): ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $recentLaundry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item px-0 py-2">
                            <div class="d-flex w-100 justify-content-between align-items-start">
                                <div class="flex-grow-1 me-2">
                                    ...
                                    <?php if($l->layanan && $l->layanan->count() > 0): ?>
                                        <small class="text-muted" style="font-size: 0.7rem;"><?php echo e($l->layanan->count()); ?> layanan</small>
                                    <?php endif; ?>
                                </div>
                                <?php if($l->layanan && $l->layanan->count() > 0): ?>
                                    <span class="badge bg-success" style="font-size: 0.75rem; white-space: nowrap;">
                                        Rp <?php echo e(number_format($l->layanan->min('harga') / 1000, 0)); ?>k
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <div class="modal-footer" style="padding: 0.75rem 1.25rem;">
                <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Tutup</button>
                <a href="<?php echo e(route('laundry.index')); ?>" class="btn btn-sm" style="background: #f5576c; color: white;">
                    <i class="bi bi-arrow-right-circle me-1"></i>Lihat Semua
                </a>
            </div>
        </div>
...
<div class="modal fade" id="kriteriaModal" tabindex="-1" aria-labelledby="kriteriaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
                    ...
                    <div class="col-6">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h5 class="mt-1 mb-0 fw-bold" style="color: #4facfe; font-size: 1.25rem;"><?php echo e($jumlahKriteria); ?></h5>
                ...
                <div class="list-group list-group-flush">
                    <div class="list-group-item px-0 py-2">
                        <div class="d-flex w-100 justify-content-between align-items-center">
                            ...
                            <span class="badge" style="font-size: 0.75rem; background-color: #667eea;"><?php echo e($jumlahKriteria); ?></span>
                        </div>
                    </div>
                    <div class="list-group-item px-0 py-2">
                        <div class="d-flex w-100 justify-content-between align-items-center">
            ...
            <div class="modal-footer" style="padding: 0.75rem 1.25rem;">
                <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Tutup</button>
                <a href="<?php echo e(route('kriteria.index')); ?>" class="btn btn-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                    <i class="bi bi-arrow-right-circle me-1"></i>Lihat Semua
                </a>
            </div>
        </div>
...
<div class="modal fade" id="sawModal" tabindex="-1" aria-labelledby="sawModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
                    ...
                    <div class="col-6">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body text-center p-2">
                                ...
                                <h5 class="mt-1 mb-0 fw-bold" style="color: #fa709a; font-size: 1.25rem;"><?php echo e($jumlahKriteria); ?></h5>
            ...
            <div class="modal-footer" style="padding: 0.75rem 1.25rem;">
                <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Tutup</button>
                <a href="<?php echo e(route('saw.index')); ?>" class="btn btn-sm" style="background: #fa709a; color: white;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TA\spk_kontrakan\resources\views/dashboard/index.blade.php ENDPATH**/ ?>