...
<div class="container-fluid px-2 px-md-3 page-kontrakan" style="padding-top: 0.5rem; padding-bottom: 1rem;">
    ...
    <div class="header-kontrakan">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-4 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('kontrakan.create')); ?>" class="btn btn-tambah-kontrakan">
    ...
    <div class="stats-overview">
        <div class="stat-card" style="--stat-color: #667eea;">
            ...
            <div class="stat-value"><?php echo e($kontrakan->total() ?? 0); ?></div>
        ...
        <div class="stat-card" style="--stat-color: #28a745;">
            ...
            <div class="stat-value"><?php echo e(isset($hargaMin) ? 'Rp ' . number_format($hargaMin / 1000000, 1) . 'jt' : '-'); ?></div>
        ...
        <div class="stat-card" style="--stat-color: #dc3545;">
            ...
            <div class="stat-value"><?php echo e(isset($jarakMaxKm) ? number_format($jarakMaxKm, 1) . 'km' : '-'); ?></div>
        ...
        <div class="stat-card" style="--stat-color: #ffc107;">
            ...
            <div class="stat-value"><?php echo e(isset($jumlah_kamarMax) ? $jumlah_kamarMax : '-'); ?></div>
    ...
    <div class="glass-card mb-3" style="overflow: hidden; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
        ...
        <div class="collapse" id="collapseFilters">
            <div class="p-2 p-md-3" style="background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
                <form action="<?php echo e(route('kontrakan.index')); ?>" method="GET" id="filterForm">
                ...
                <div class="border-top mt-2 pt-2">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-text">
                                ...
                                <span class="d-none d-md-inline">Range tersedia: Rp <?php echo e(number_format($hargaMin, 0, ',', '.')); ?> - Rp <?php echo e(number_format($hargaMax, 0, ',', '.')); ?></span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">
                                <i class="bi bi-info-circle me-1" style="color: var(--info-color);"></i>
                                <span class="d-none d-md-inline">Jarak terjauh tersedia: <?php echo e($jarakMaxKm); ?> km</span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="range-slider p-2 rounded-3" style="background: rgba(var(--warning-color-rgb), 0.05); border: 1px solid rgba(var(--warning-color-rgb), 0.1);">
                                <div class="row g-2 mb-2">
                                    <div class="col-6">
                                        <div class="range-value text-center p-1 rounded" style="background: white; border: 2px solid var(--warning-color); color: var(--warning-color); font-weight: 600; font-size: 0.85rem;">
                                            <small class="d-block text-muted" style="font-size: 0.7rem;">Min</small>
                                            <span id="kamarMinDisplay"><?php echo e($filters['jumlah_kamar_min'] ?? $jumlah_kamarMin); ?></span> kmr
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="range-value text-center p-1 rounded" style="background: white; border: 2px solid var(--warning-color); color: var(--warning-color); font-weight: 600; font-size: 0.85rem;">
                                            <small class="d-block text-muted" style="font-size: 0.7rem;">Max</small>
                                            <span id="kamarMaxDisplay"><?php echo e($filters['jumlah_kamar_max'] ?? $jumlah_kamarMax); ?></span> kmr
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        <input 
                                            ...
                                            id="kamar_min" 
                                            class="form-range" 
                                            min="<?php echo e($jumlah_kamarMin); ?>" 
                                            max="<?php echo e($jumlah_kamarMax); ?>" 
                                            value="<?php echo e($filters['jumlah_kamar_min'] ?? $jumlah_kamarMin); ?>"
                                            step="1"
                                    ...
                                    <div class="col-md-6">
                                        <input 
                                            ...
                                            min="<?php echo e($jumlah_kamarMin); ?>" 
                                            max="<?php echo e($jumlah_kamarMax); ?>" 
                                            value="<?php echo e($filters['jumlah_kamar_max'] ?? $jumlah_kamarMax); ?>"
                                            step="1"
                                            style="accent-color: var(--warning-color);"
                                        >
                                ...
                                <div class="form-text">
                                    ...
                                    Range: <?php echo e($jumlah_kamarMin); ?> - <?php echo e($jumlah_kamarMax); ?> kamar
                                </div>
                            </div>
                                        ...
                                        <div class="col-6 col-md-4 col-lg-3">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label small" for="fasilitas_<?php echo e($loop->index); ?>" style="cursor: pointer;">
                                                    <i class="bi bi-check-circle me-1" style="color: var(--success-color);"></i><?php echo e($fasilitas); ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-6 col-md-3">
                                    <input type="radio" class="btn-check" name="sort_by" id="sort_kamar_terbanyak" value="jumlah_kamar_terbesar" <?php echo e(($filters['sort_by'] ?? '') == 'jumlah_kamar_terbesar' ? 'checked' : ''); ?>>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-2 mt-4 pt-3 border-top">
                        ...
                        <a href="<?php echo e(route('kontrakan.index')); ?>" class="btn btn-outline-secondary flex-fill">
            ...
            <div class="d-flex flex-column flex-md-row gap-2 align-items-start align-items-md-center justify-content-between">
                <div class="d-flex flex-wrap gap-2 align-items-center w-100 w-md-auto">
                    ...
                    <span class="badge px-2 py-1 rounded-3" style="background: rgba(var(--primary-color-rgb), 0.1); color: var(--primary-color); font-size: 0.85rem; font-weight: 600;">
                        ...
                        <?php if(isset($filteredCount) && isset($totalKontrakan) && $filteredCount < $totalKontrakan): ?>
                        <span class="d-none d-md-inline">dari <?php echo e($totalKontrakan); ?></span>
                        <?php endif; ?>
                        kontrakan
                    </span>
                    ...
                    <?php if(($filters['jumlah_kamar_min'] ?? false) || ($filters['jumlah_kamar_max'] ?? false)): ?>
                    <span class="badge px-2 px-md-3 py-2 rounded-3" style="background: rgba(var(--warning-color-rgb), 0.1); color: var(--warning-color); font-size: 0.85rem;">
                        ...
                        <span class="d-none d-md-inline"><?php echo e($filters['jumlah_kamar_min'] ?? 0); ?> - <?php echo e($filters['jumlah_kamar_max'] ?? ($jumlah_kamarMax ?? 0)); ?> kamar</span>
                        <span class="d-md-none">🏠<?php echo e($filters['jumlah_kamar_min'] ?? 0); ?>-<?php echo e($filters['jumlah_kamar_max'] ?? ($jumlah_kamarMax ?? 0)); ?></span>
                    </span>
                    <?php endif; ?>
                ...
                <div class="btn-group" role="group">
                    <a href="<?php echo e(route('export.kontrakan.excel')); ?><?php echo e($queryString); ?>" 
                    ...
                    <a href="<?php echo e(route('export.kontrakan.pdf')); ?><?php echo e($queryString); ?>" 
    ...
    <div class="main-content-card">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 w-100">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-2 w-100 w-md-auto">
                    <span class="text-muted small">
                        <i class="bi bi-info-circle me-1" style="color: var(--info-color);"></i>
                        <strong><?php echo e($kontrakan->count()); ?></strong> kontrakan
                    </span>
                    
                    <!-- Bulk Action Buttons - Style seperti Laundry -->
                    <?php if(auth()->user()->role == 'super_admin' && $kontrakan->count() > 0): ?>
                ...
                <span class="badge px-3 py-2 rounded-3" style="background: rgba(var(--primary-color-rgb), 0.1); color: var(--primary-color); font-size: 0.9rem; font-weight: 600;">
                    ...
                    <strong><?php echo e($kontrakan->total()); ?></strong> Data
                </span>
            </div>
        </div>

        <div class="card-body p-0">
            <?php if($kontrakan->isEmpty()): ?>
                <!-- Empty State -->
                <div class="text-center py-5 px-3" style="background: rgba(var(--primary-color-rgb), 0.02);">
                    ...
                    <p class="text-muted mb-4 small" style="color: var(--text-muted);">
                        <?php if(request()->hasAny(['search', 'harga_min', 'harga_max', 'jarak_max', 'luas_min', 'luas_max', 'fasilitas_filter'])): ?>
                    ...
                    <div class="d-flex gap-2 justify-content-center flex-column flex-sm-row">
                        <?php if(request()->hasAny(['search', 'harga_min', 'harga_max', 'jarak_max', 'luas_min', 'luas_max', 'fasilitas_filter'])): ?>
                        <a href="<?php echo e(route('kontrakan.index')); ?>" class="btn btn-outline-primary btn-sm" style="border-color: var(--primary-color); color: var(--primary-color);">
                            <i class="bi bi-arrow-clockwise me-2"></i>
                            <span class="d-none d-sm-inline">Reset Filter</span>
                            <span class="d-sm-none">Reset</span>
                        </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('kontrakan.create')); ?>" class="btn btn-sm" style="background: var(--primary-color); border-color: var(--primary-color); color: white;">
            ...
            <?php else: ?>
                <!-- Mobile Card View -->
                <div class="d-md-none">
                    <?php $__currentLoopData = $kontrakan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="d-flex align-items-start gap-2 flex-grow-1">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-2 fw-bold" style="color: var(--text-primary); font-size: 1.1rem;">
                                            ...
                                            <span class="badge <?php echo e($item->status_badge_class); ?> ms-1" style="font-size: 0.65rem;"><?php echo e($item->status_label); ?></span>
                                        </h6>
                                ...
                                <span class="badge rounded-pill px-2 py-1" style="background: rgba(var(--primary-color-rgb), 0.1); color: var(--primary-color); font-size: 0.75rem;">
                                    #<?php echo e($kontrakan->firstItem() + $index); ?>
                            ...
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <span class="badge w-100 py-2 rounded-3" style="background: rgba(var(--info-color-rgb), 0.1); color: var(--info-color); font-size: 0.8rem; font-weight: 600;">
                                        <?php echo e(number_format($item->jarak / 1000, 1)); ?> km
                                    </span>
                                </div>
                                <div class="col-3">
                            ...
                            <!-- Fasilitas -->
                            <?php if($item->fasilitas): ?>
                            <div class="mb-3">
                                <small class="text-muted d-block mb-2">✨ Fasilitas:</small>
                                <div class="d-flex flex-wrap gap-1">
                                    <?php $__currentLoopData = array_slice(array_map('trim', explode(',', $item->fasilitas)), 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="badge border small rounded-pill px-2 py-1" style="background: rgba(var(--secondary-color-rgb), 0.1); border-color: var(--border-color); color: var(--text-secondary); font-size: 0.75rem;"><?php echo e($f); ?></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(count(explode(',', $item->fasilitas)) > 3): ?>
                                    <span class="badge small rounded-pill px-2 py-1" style="background: var(--secondary-color); color: white; font-size: 0.75rem;">+<?php echo e(count(explode(',', $item->fasilitas)) - 3); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <!-- WhatsApp Button -->
                            <?php if($item->hasWhatsapp()): ?>
                            <a href="<?php echo e($item->whatsapp_url); ?>" target="_blank" class="btn btn-sm w-100 mb-3 rounded-3" style="background: #25D366; border-color: #25D366; color: white; font-weight: 600; padding: 0.5rem;">
                            ...
                            <div class="d-flex gap-1">
                                ...
                                <?php endif; ?>
                                <a 
                                    href="<?php echo e(route('kontrakan.show', $item->id)); ?>" 
                                    class="btn btn-sm flex-fill rounded-3"
                                    title="Detail"
                                ...
                                <a 
                                    href="<?php echo e(route('kontrakan.edit', $item->id)); ?>" 
                                    class="btn btn-sm flex-fill rounded-3"
                                    title="Edit"
                                ...
                                <button 
                                    type="button" 
                                    class="btn btn-sm flex-fill rounded-3"
                                    onclick="showDeleteModal(<?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>, <?php echo e(json_encode($item->alamat)); ?>, <?php echo e(json_encode('Rp ' . number_format($item->harga, 0, ',', '.'))); ?>)"
                                    title="Hapus"
                                ...
                                <form 
                                    ...
                                    action="<?php echo e(route('kontrakan.destroy', $item->id)); ?>" 
                                    method="POST" 
                                    class="d-none"
                                >
                                    <?php echo csrf_field(); ?>
                    ...
                    <table class="table enhanced-table align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-3">
                                    <span class="badge rounded-pill fw-bold" style="background: rgba(var(--primary-color-rgb), 0.1); color: var(--primary-color);"><?php echo e($kontrakan->firstItem() + $index); ?></span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div style="min-width: 0;">
                                            <h6 class="mb-1 fw-bold" style="color: var(--text-primary);">
                                                ...
                                                <span class="badge <?php echo e($item->status_badge_class); ?> ms-1" style="font-size: 0.7rem;"><?php echo e($item->status_label); ?></span>
                                            </h6>
                                            <?php if($item->hasWhatsapp()): ?>
                                ...
                                <td>
                                    <?php if($item->fasilitas): ?>
                                    <div class="d-flex flex-wrap gap-1">
                                        <?php $__currentLoopData = array_slice(array_map('trim', explode(',', $item->fasilitas)), 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="badge border small rounded-pill px-2 py-1" style="background: rgba(var(--secondary-color-rgb), 0.1); border-color: var(--border-color); color: var(--text-secondary); font-size: 0.75rem;"><?php echo e($f); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(count(explode(',', $item->fasilitas)) > 2): ?>
                                        <span class="badge small rounded-pill px-2 py-1" style="background: var(--secondary-color); color: white; font-size: 0.75rem;" title="<?php echo e($item->fasilitas); ?>">+<?php echo e(count(explode(',', $item->fasilitas)) - 2); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <?php else: ?>
                                ...
                                <td class="text-center">
                                    <span class="badge px-3 py-2 rounded-3" style="background: rgba(var(--warning-color-rgb), 0.1); color: var(--warning-color); font-weight: 600;">
                                        <i class="bi bi-door-closed me-1"></i><?php echo e($item->jumlah_kamar); ?> Kamar
                                    </span>
                                </td>
                                <td class="text-center">
                                    <div class="btn-group" role="group">
        ...
        <div class="card-footer border-0 py-4" style="background: linear-gradient(135deg, rgba(255,255,255,0.98), rgba(248,249,255,0.95)); backdrop-filter: blur(10px); border-radius: 0 0 1.25rem 1.25rem;">
            <?php echo e($kontrakan->links('vendor.pagination.custom')); ?>
...
<form id="bulkDeleteForm" action="<?php echo e(route('kontrakan.bulk-destroy')); ?>" method="POST" class="d-none">
    <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (clearSearchMobile) {
        clearSearchMobile.addEventListener('click', function() {
            ...
            window.location.href = '<?php echo e(route('kontrakan.index')); ?>';
        });
    }
...
const hasActiveFilters = <?php echo e((request()->hasAny(['search', 'harga_min', 'harga_max', 'jarak_max', 'luas_min', 'luas_max', 'fasilitas_filter']) || 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TA\spk_kontrakan\resources\views/kontrakan/index.blade.php ENDPATH**/ ?>