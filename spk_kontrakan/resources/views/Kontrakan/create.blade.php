        ...
        <div class="col-12">
            <div class="card form-card">
                <div class="card-body p-4">
                    <form action="{{ route('kontrakan.store') }}" method="POST" enctype="multipart/form-data" id="kontrakanForm">
                        @csrf
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input 
                                            type="file" 
                                            name="foto" 
                                            class="form-control border-start-0 @error('foto') is-invalid @enderror" 
                                            id="foto" 
