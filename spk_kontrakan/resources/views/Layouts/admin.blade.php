...
<head>
    ...
    <title>@yield('title', 'Admin Panel - SPK Kontrakan & Laundry')</title>
                ...
                <div class="admin-user" data-bs-toggle="dropdown">
                    ...
                    <div class="user-info">
                        ...
                        <span class="user-role">
                            <i class="bi bi-briefcase me-1"></i>{{ ucfirst(Auth::user()->role) }}
                        </span>
                    </div>
    ...
    <div class="admin-sidebar" id="sidebar">
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('kontrakan.index') }}" class="menu-item menu-kontrakan {{ request()->routeIs('kontrakan.*') ? 'active' : '' }}">
                    <i class="bi bi-building"></i>
